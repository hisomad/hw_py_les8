...
def add_contact(value=1):
    ...
    return {'id': value, 'surname': surname, 'name': name, 'patronymic': patronymic, 'phone_number': phone_number, 'e_mail': e_mail,
...
def update_value(data):
    ...
    patronymic = input('Измените отчество: ')
    ...
    return {'surname': surname, 'name': name, 'patronymic': patronymic, 'phone_number': phone_number, 'e_mail': e_mail, 'update_date': update_date}
